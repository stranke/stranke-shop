...
require_once $_SERVER['DOCUMENT_ROOT'].'/bitrix/modules/stranke.shop/classes/SettingsHelper.php';


$iblockType = "services";
$iblockCode = "services_settings";
$iblockXmlId = $iblockCode . "_" . WIZARD_SITE_ID;
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/".LANGUAGE_ID."/setting/setting.xml";
...
$settingsHelper = new SettingsHelper($wizard, $iblockID);
