...
$currentInstallEshoApp = COption::GetOptionString("shop", "installEshopApp", "N", WIZARD_SITE_ID);
if ($currentInstallEshoApp != "Y" && $installEshopApp == "Y")
	$wizardInstallEshopApp = true;
COption::SetOptionString("shop", "installEshopApp", $installEshopApp, false, WIZARD_SITE_ID);
