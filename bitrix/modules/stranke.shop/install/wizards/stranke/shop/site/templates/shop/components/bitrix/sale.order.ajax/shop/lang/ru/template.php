...
$MESS["SOA_ORDER_SUC"] = "Ваш заказ успешно оформлен!";
$MESS["SOA_ORDER_SUC_TEXT"] = "Наши менеджеры уже проверяют заказ и скоро позвонят для уточнения заказа.";
$MESS["SOA_ORDER_SUC2"] = "Хорошо";
...
$MESS["STRANKE_SOA_TITLE"] = "Оформление заказа";
$MESS["STRANKE_SOA_DELIVERY_PRICE"] = "Стоимость:";
?>
