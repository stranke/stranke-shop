...
<div class="catalog-element">
    <div class="products__product" itemscope itemtype="http://schema.org/Product">
        ...
        <?
        $arProp = $GLOBALS['PRODUCT_PROP'];
        $arPhotoElementsID= $arProp['dop_photo']['VALUE'];
        $elementIDList = $arProp['RELATED_PRODUCTS']['VALUE'];
        ?>
        ...
        <div class="product__bottom-block">
            ...
            <?$APPLICATION->IncludeComponent(
                ...
                array(
                    ...
                    "SHOW_FORM" => "Y",
                    "REVIEW_FOR_PRODUCT_ID" => $GLOBALS['CATALOG_CURRENT_ELEMENT_ID']
                ),
                $component
            );?>
            ...
            <?
            if ((count($elementIDList) > 1) || ($elementIDList[0] !== null)) {
                $GLOBALS['arRelatedProductsFilter'] = array(
                    'ID' => $elementIDList
                );
