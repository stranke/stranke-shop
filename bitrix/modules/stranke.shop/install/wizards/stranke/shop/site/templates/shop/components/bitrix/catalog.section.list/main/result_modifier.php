...
foreach ($arResult['SECTIONS'] as $arSection) {
    if (!empty($arSection['UF_SEO_SECTION'])) continue;

    if (!empty($arSection['PICTURE']['ID'])) {
        $imgID = $arSection['PICTURE']['ID'];
    } else {
    ...
    if ($arSection['UF_PRICE_FROM']) {
        $arSection['MIN_PRICE'] = GetMessage('CT_PRODUCT_PRICE_FROM') . FormatCurrency(round($arSection['UF_PRICE_FROM']), "RUB");
    }
