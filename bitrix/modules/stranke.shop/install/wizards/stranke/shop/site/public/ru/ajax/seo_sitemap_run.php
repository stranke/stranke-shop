...
//							remove or replace SERVER_NAME
              ...
              if( $arElement["IBLOCK_ID"] == "5" || $arElement["IBLOCK_ID"] == "6"){
                $sitemapFile->addIBlockEntry($url."characteristics/", $elementLastmod);
                $sitemapFile->addIBlockEntry($url."video/", $elementLastmod);
                $sitemapFile->addIBlockEntry($url."reviews/", $elementLastmod);
                $sitemapFile->addIBlockEntry($url."support/", $elementLastmod);
                $sitemapFile->addIBlockEntry($url."zip/", $elementLastmod);
              }
