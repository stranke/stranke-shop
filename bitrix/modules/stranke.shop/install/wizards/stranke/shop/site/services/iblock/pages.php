...
$iblockType = "content";
$iblockCode = "content_pages_" . WIZARD_SITE_ID;
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/pages/pages.xml";
...
$arFilter = ['IBLOCK_ID' => $iblockID, 'CODE' => 'main'];
$element = CIBlockElement::GetList([], $arFilter)->Fetch();
CWizardUtil::ReplaceMacros(
    WIZARD_SITE_PATH . "/.top.menu_ext.php",
    ["PAGES_IBLOCK_ID" => $iblockID,]
);
CWizardUtil::ReplaceMacros(
    WIZARD_SITE_PATH . "/page/index.php",
    ["PAGES_IBLOCK_ID" => $iblockID,]
);
