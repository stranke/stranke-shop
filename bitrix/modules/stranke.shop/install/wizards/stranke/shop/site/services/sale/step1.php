...
COption::SetOptionString("shop", "shopLocalization", $shopLocalization, "ru", WIZARD_SITE_ID);
...
if($bRus || COption::GetOptionString("shop", "wizard_installed", "N", WIZARD_SITE_ID) != "Y" || WIZARD_INSTALL_DEMO_DATA)
{
	...
	if ($shopLocalization == "ru")
	{
		...
		COption::SetOptionString("shop", "shopLocation", $shopLocation, false, WIZARD_SITE_ID);
		$shopOfName = $wizard->GetVar("shopOfName");
		COption::SetOptionString("shop", "shopOfName", $shopOfName, false, WIZARD_SITE_ID);
		$shopAdr = $wizard->GetVar("shopAdr");
		COption::SetOptionString("shop", "shopAdr", $shopAdr, false, WIZARD_SITE_ID);

		$shopINN = $wizard->GetVar("shopINN");
		COption::SetOptionString("shop", "shopINN", $shopINN, false, WIZARD_SITE_ID);
		$shopKPP = $wizard->GetVar("shopKPP");
		COption::SetOptionString("shop", "shopKPP", $shopKPP, false, WIZARD_SITE_ID);
		$shopNS = $wizard->GetVar("shopNS");
		COption::SetOptionString("shop", "shopNS", $shopNS, false, WIZARD_SITE_ID);
		$shopBANK = $wizard->GetVar("shopBANK");
		COption::SetOptionString("shop", "shopBANK", $shopBANK, false, WIZARD_SITE_ID);
		$shopBANKREKV = $wizard->GetVar("shopBANKREKV");
		COption::SetOptionString("shop", "shopBANKREKV", $shopBANKREKV, false, WIZARD_SITE_ID);
		$shopKS = $wizard->GetVar("shopKS");
		COption::SetOptionString("shop", "shopKS", $shopKS, false, WIZARD_SITE_ID);
		$siteStamp = $wizard->GetVar("siteStamp");
		if ($siteStamp == "" )
			$siteStamp = COption::GetOptionString("shop", "siteStamp", "", WIZARD_SITE_ID);
	}
	elseif ($shopLocalization == "ua")
	{
		...
		COption::SetOptionString("shop", "shopLocation_ua", $shopLocation, false, WIZARD_SITE_ID);
		$shopOfName = $wizard->GetVar("shopOfName_ua");
		COption::SetOptionString("shop", "shopOfName_ua", $shopOfName, false, WIZARD_SITE_ID);
		$shopAdr = $wizard->GetVar("shopAdr_ua");
		COption::SetOptionString("shop", "shopAdr_ua", $shopAdr, false, WIZARD_SITE_ID);

		$shopEGRPU_ua = $wizard->GetVar("shopEGRPU_ua");
		COption::SetOptionString("shop", "shopEGRPU_ua", $shopEGRPU_ua, false, WIZARD_SITE_ID);
		$shopINN_ua = $wizard->GetVar("shopINN_ua");
		COption::SetOptionString("shop", "shopINN_ua", $shopINN_ua, false, WIZARD_SITE_ID);
		$shopNDS_ua = $wizard->GetVar("shopNDS_ua");
		COption::SetOptionString("shop", "shopNDS_ua", $shopNDS_ua, false, WIZARD_SITE_ID);
		$shopNS_ua = $wizard->GetVar("shopNS_ua");
		COption::SetOptionString("shop", "shopNS_ua", $shopNS_ua, false, WIZARD_SITE_ID);
		$shopBank_ua = $wizard->GetVar("shopBank_ua");
		COption::SetOptionString("shop", "shopBank_ua", $shopBank_ua, false, WIZARD_SITE_ID);
		$shopMFO_ua = $wizard->GetVar("shopMFO_ua");
		COption::SetOptionString("shop", "shopMFO_ua", $shopMFO_ua, false, WIZARD_SITE_ID);
		$shopPlace_ua = $wizard->GetVar("shopPlace_ua");
		COption::SetOptionString("shop", "shopPlace_ua", $shopPlace_ua, false, WIZARD_SITE_ID);
		$shopFIO_ua = $wizard->GetVar("shopFIO_ua");
		COption::SetOptionString("shop", "shopFIO_ua", $shopFIO_ua, false, WIZARD_SITE_ID);
		$shopTax_ua = $wizard->GetVar("shopTax_ua");
		COption::SetOptionString("shop", "shopTax_ua", $shopTax_ua, false, WIZARD_SITE_ID);
	}

	$siteTelephone = $wizard->GetVar("siteTelephone");
	COption::SetOptionString("shop", "siteTelephone", $siteTelephone, false, WIZARD_SITE_ID);
	$shopEmail = $wizard->GetVar("shopEmail");
	COption::SetOptionString("shop", "shopEmail", $shopEmail, false, WIZARD_SITE_ID);
	...
	if(strlen($siteStamp)>0)
	{
		if(IntVal($siteStamp) > 0)
		{
			...
			if($zr = $ff->Fetch())
			{
				...
				COption::SetOptionString("shop", "siteStamp", $siteStamp, false, WIZARD_SITE_ID);
			}
		}
	}
	else
	...
	COption::SetOptionString("shop", "personTypeFiz", $personTypeFiz, false, WIZARD_SITE_ID);
	$personTypeUr = (isset($personType["ur"]) && $personType["ur"] == "Y" ? "Y" : "N");
	COption::SetOptionString("shop", "personTypeUr", $personTypeUr, false, WIZARD_SITE_ID);
	...
	if ($shopLocalization == "ua")
	{
		...
		COption::SetOptionString("shop", "personTypeFizUa", $personTypeFizUa, false, WIZARD_SITE_ID);
...
//		);
		...
		$businessValueCodes['CLIENT_STREET'] = array('GROUP' => 'CLIENT', 'SORT' =>  150, 'DOMAIN' => $BIZVAL_INDIVIDUAL_DOMAIN);
		$arProps[] = Array(
				"PERSON_TYPE_ID" => $arGeneralInfo["personType"]["fiz"],
        ...
        $businessValueCodes['CLIENT_HOME'] = array('GROUP' => 'CLIENT', 'SORT' =>  160, 'DOMAIN' => $BIZVAL_INDIVIDUAL_DOMAIN);
        $arProps[] = Array(
            "PERSON_TYPE_ID" => $arGeneralInfo["personType"]["fiz"],
            "NAME" => GetMessage("ST_PROP_HOME"),
            "TYPE" => "TEXT",
            "REQUIED" => "Y",
            "DEFAULT_VALUE" => "",
            "SORT" => 50,
            ...
            "IS_FILTERED" => "N",
            "IS_ADDRESS" => "N",
            "SETTINGS" => array("MAXLENGTH" => 25),
        );

        $businessValueCodes['CLIENT_APARTMENT'] = array('GROUP' => 'CLIENT', 'SORT' =>  170, 'DOMAIN' => $BIZVAL_INDIVIDUAL_DOMAIN);
        $arProps[] = Array(
            "PERSON_TYPE_ID" => $arGeneralInfo["personType"]["fiz"],
            "NAME" => GetMessage("ST_PROP_APARTMENT"),
            "TYPE" => "TEXT",
            "REQUIED" => "Y",
            "DEFAULT_VALUE" => "",
            "SORT" => 60,
        ...
        $businessValueCodes['CLIENT_ENTRANCE'] = array('GROUP' => 'CLIENT', 'SORT' =>  180, 'DOMAIN' => $BIZVAL_INDIVIDUAL_DOMAIN);
        $arProps[] = Array(
            "PERSON_TYPE_ID" => $arGeneralInfo["personType"]["fiz"],
            "NAME" => GetMessage("ST_PROP_ENTRANCE"),
            "TYPE" => "TEXT",
            "REQUIED" => "Y",
            "DEFAULT_VALUE" => "",
            "SORT" => 70,
        ...
        $businessValueCodes['CLIENT_FLOOR'] = array('GROUP' => 'CLIENT', 'SORT' =>  190, 'DOMAIN' => $BIZVAL_INDIVIDUAL_DOMAIN);
        $arProps[] = Array(
            "PERSON_TYPE_ID" => $arGeneralInfo["personType"]["fiz"],
            "NAME" => GetMessage("ST_PROP_FLOOR"),
            "TYPE" => "TEXT",
            "REQUIED" => "Y",
            "DEFAULT_VALUE" => "",
            "SORT" => 80,
