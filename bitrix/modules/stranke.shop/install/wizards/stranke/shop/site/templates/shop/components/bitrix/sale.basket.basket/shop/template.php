...
if (empty($arResult['ERROR_MESSAGE']))
{
    ...
    <div class="wrapper">
        <div id="basket-root" class="bx-basket bx-step-opacity" style="opacity: 0;">
            <h1><?=GetMessage('ST_BASKET_TITLE')?></h1>

            <?if ($app->config->basketTerms):?>
                <div class="bx-basket__card">
                    <div class="bx-basket__card-header"><?=GetMessage('ST_BASKET_TERMS')?></div>
                    <div class="bx-basket__card-body"><?=$app->config->basketTerms?></div>
                </div>
            <?endif?>
            ...
            <div class="bx-basket__card">
                ...
                <div class="basket-items-list-wrapper basket-items-list-wrapper-height-fixed basket-items-list-wrapper-light<?=$displayModeClass?>"
                    ...
                    <?/*<div class="basket-items-list-title">
                        <?=GetMessage('ST_BASKET_ITEMS')?>
                    </div>*/?>
