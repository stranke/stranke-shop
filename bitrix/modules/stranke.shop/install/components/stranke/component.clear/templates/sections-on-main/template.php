...
use Stranke\Optimization\Image;
...
<div class="wrapper main-page__products-on-main">
    <div class="container">
        <div class="products-on-main">
            <div class="products-on-main__title"><?= GetMessage('CT_SECTIONS_ON_MAIN_TITLE_1') ?> <?= $arResult['SECTIONS_COUNT'] ?> <?= GetMessage('CT_SECTIONS_ON_MAIN_TITLE_2') ?></div>

            <div class="products-on-main__sub-title">    <? $APPLICATION->IncludeComponent(
                    "bitrix:main.include",
                    "",
                    Array(
                        "AREA_FILE_SHOW" => "file",
                        "PATH" => SITE_DIR . "include/sections-on-main.php",
            ...
            <div class="products-on-main_item-list" itemscope itemtype="http://schema.org/ItemList">
                <? foreach ($arResult['SECTIONS'] as $key => $arSection): ?>
                    ...
                    <div class="products-on-main__item" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                        ...
                        <a class="products-on-main__item-link" href="<?= $arSection['link'] ?>" itemprop="url">
                            <div class="products-on-main__item-image<?= $img ? '' : ' no_img' ?>">
                            ...
                            <div class="products-on-main__item-name" itemprop="name"><?= $arSection['name'] ?></div>
                            <div class="products-on-main__item-price"><?= $arSection['price'] ?></div>
                        </a>
                    </div>
                <? endforeach ?>
            </div>
            ...
            <div class="products-on-main__all-products-btn js-productsOnMainAllProductsBtn">
                <span data-href="/catalog/"><?= GetMessage('CT_SECTIONS_ON_MAIN_BTN') ?></span>
            </div>

            <? /*
            <div class="products-on-main__list-btn js-productOnMainListBtn">
                <span class="show">Показать еще <i class="fas fa-chevron-down"></i></span>
                <span class="hidden">Скрыть <i class="fas fa-chevron-up"></i></span>
            </div>
            */ ?>
        </div>
    </div>
